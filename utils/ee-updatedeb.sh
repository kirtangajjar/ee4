#!/bin/bash
#
# Package ee to be installed in Debian-compatible systems.
...
DIR="php-wpcli"
# phar URL
PHAR="https://github.com/ee/builds/raw/gh-pages/phar/ee.phar"
...
Homepage: http://ee.org/
Description: ee is a set of command-line tools for managing
...
if ! [ -r usr/share/doc/php-wpcli/copyright ]; then
    ...
    wget -nv -O usr/share/doc/php-wpcli/copyright https://github.com/ee/ee/raw/master/LICENSE
fi
...
[ -z "$WPCLI_VER" ] && die 5 "Cannot get ee version"
