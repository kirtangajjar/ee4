...
// EE: run enable_maintenance_mode filter early for compat with < WP 4.6
/**
...
// EE: run enable_wp_debug_mode_checks filter early for compat with < WP 4.6
/**
...
// EE: Handle db error ourselves, instead of waiting for dead_db()
global $wpdb;
if ( ! empty( $wpdb->error ) ) {
	wp_die( $wpdb->error );
}
...
// EE: Permit Utils\wp_not_installed() to run on < WP 4.0
